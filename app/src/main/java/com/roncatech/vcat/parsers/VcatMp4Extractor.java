 ...
 */
@Deprecated
public final class VcatMp4Extractor implements Extractor, SeekMap {

  /** Factory for {@link VcatMp4Extractor} instances. */
  public static final ExtractorsFactory FACTORY = () -> new Extractor[] {new VcatMp4Extractor()};
   ...
   */
  public VcatMp4Extractor(@Flags int flags) {
    this.flags = flags;
    parserState =
