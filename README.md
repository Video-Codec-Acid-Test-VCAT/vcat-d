...
See:
- GPL-3.0 license text: <https://github.com/Video-Codec-Acid-Test-VCAT/vcat-d/blob/plugin-decoder/LICENSE>
- Decoder plugin additional permission: <https://github.com/Video-Codec-Acid-Test-VCAT/vcat-d/blob/plugin-decoder/LICENSE-PLUGIN-EXCEPTION.md>
